module github.com/bacherfl/flagd-performance-test
...
require (
	buf.build/gen/go/open-feature/flagd/protocolbuffers/go v1.30.0-20230317150644-afd1cc2ef580.1 // indirect
